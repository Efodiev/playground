...
const DISTRICTS: District[] = [
  {
    ...
    settlements: [
      ...
      { name: "Валя-Адынкэ", type: "village", lat: 48.0550, lng: 28.6800 },
      { name: "Войтовка", type: "village", lat: 48.0600, lng: 28.7500 },
      { name: "Грушка", type: "village", lat: 48.0100, lng: 28.6800 },
      { name: "Катериновка", type: "village", lat: 48.0250, lng: 28.6600 },
      { name: "Константиновка", type: "village", lat: 48.0350, lng: 28.6700 },
      { name: "Красный Октябрь", type: "village", lat: 48.0650, lng: 28.6900 },
      { name: "Кузьмин", type: "village", lat: 47.9950, lng: 28.7300 },
      { name: "Окница", type: "village", lat: 48.0700, lng: 28.6600 },
      { name: "Подойма", type: "village", lat: 48.0150, lng: 28.7500 },
      { name: "Подоймица", type: "village", lat: 48.0180, lng: 28.7550 },
      { name: "Рашково", type: "village", lat: 47.9850, lng: 28.7400 },
      { name: "Ротар", type: "village", lat: 48.0400, lng: 28.7600 },
      { name: "Садки", type: "village", lat: 48.0500, lng: 28.7700 },
      { name: "Севериновка", type: "village", lat: 48.0700, lng: 28.7300 },
      { name: "Слобода-Рашково", type: "village", lat: 47.9900, lng: 28.7100 },
      { name: "Соколовка", type: "village", lat: 48.0800, lng: 28.7000 },
      { name: "Солнечное", type: "village", lat: 48.0450, lng: 28.6500 },
      { name: "Фрунзовка", type: "village", lat: 48.0050, lng: 28.6500 },
      { name: "Хрустовая", type: "village", lat: 48.0800, lng: 28.7400 },
      { name: "Янтарное", type: "village", lat: 48.0550, lng: 28.7100 },
    ],
  },
  {
    name: "Рыбницкий",
    settlements: [
      ...
      { name: "Андреевка", type: "village", lat: 47.7150, lng: 29.0500 },
      { name: "Белочи", type: "village", lat: 47.7600, lng: 28.9600 },
      { name: "Бессарабка", type: "village", lat: 47.7200, lng: 29.0100 },
      { name: "Большой Молокиш", type: "village", lat: 47.8100, lng: 29.0500 },
      { name: "Броштяны", type: "village", lat: 47.7350, lng: 29.0800 },
      { name: "Буськи", type: "village", lat: 47.7500, lng: 29.0600 },
      { name: "Бутучаны", type: "village", lat: 47.7500, lng: 28.9800 },
      { name: "Вадул-Туркулуй", type: "village", lat: 47.7700, lng: 29.0700 },
      { name: "Васильевка", type: "village", lat: 47.7250, lng: 28.9400 },
      { name: "Владимировка", type: "village", lat: 47.7100, lng: 28.9700 },
      { name: "Воронково", type: "village", lat: 47.7900, lng: 29.0800 },
      { name: "Выхватинцы", type: "village", lat: 47.7650, lng: 29.0900 },
      { name: "Гараба", type: "village", lat: 47.7400, lng: 29.0700 },
      { name: "Гершуновка", type: "village", lat: 47.8050, lng: 29.0600 },
      { name: "Гидирим", type: "village", lat: 47.8200, lng: 29.0400 },
      { name: "Димитрова", type: "village", lat: 47.7300, lng: 28.9500 },
      { name: "Ержово", type: "village", lat: 47.7950, lng: 29.0500 },
      { name: "Жура", type: "village", lat: 47.8150, lng: 29.0700 },
      { name: "Загорное", type: "village", lat: 47.7550, lng: 29.1000 },
      { name: "Запорожец", type: "village", lat: 47.7450, lng: 29.0900 },
      { name: "Зозуляны", type: "village", lat: 47.7350, lng: 28.9600 },
      { name: "Ивановка", type: "village", lat: 47.8000, lng: 28.9900 },
      { name: "Кирово", type: "village", lat: 47.7100, lng: 29.0200 },
      { name: "Колбасна", type: "pgt", lat: 47.8100, lng: 29.0300 },
      { name: "Красненькое", type: "village", lat: 47.7700, lng: 28.9300 },
      { name: "Ленино", type: "village", lat: 47.7550, lng: 28.9500 },
      { name: "Лысая Гора", type: "village", lat: 47.7800, lng: 29.1000 },
      { name: "Малая Ульма", type: "village", lat: 47.7050, lng: 29.0300 },
      { name: "Малый Молокиш", type: "village", lat: 47.8150, lng: 29.0450 },
      { name: "Михайловка", type: "village", lat: 47.7400, lng: 28.9400 },
      { name: "Мокра", type: "village", lat: 47.7250, lng: 29.0600 },
      { name: "Новая Жизнь", type: "village", lat: 47.7600, lng: 28.9300 },
      { name: "Новая Михайловка", type: "village", lat: 47.7150, lng: 28.9600 },
      { name: "Первомайск", type: "village", lat: 47.7450, lng: 29.0300 },
      { name: "Плоть", type: "village", lat: 47.7650, lng: 29.0200 },
      { name: "Победа", type: "village", lat: 47.7300, lng: 29.0100 },
      { name: "Попенки", type: "village", lat: 47.7650, lng: 29.0400 },
      { name: "Пыкалово", type: "village", lat: 47.7500, lng: 29.0700 },
      { name: "Сарацея", type: "village", lat: 47.7200, lng: 29.0400 },
      { name: "Советское", type: "village", lat: 47.7350, lng: 28.9300 },
      { name: "Станиславка", type: "village", lat: 47.7850, lng: 29.0600 },
      { name: "Строенцы", type: "village", lat: 47.8250, lng: 29.0500 },
      { name: "Сухая Рыбница", type: "village", lat: 47.7750, lng: 28.9700 },
      { name: "Ульма", type: "village", lat: 47.7000, lng: 29.0400 },
      { name: "Шевченко", type: "village", lat: 47.7550, lng: 28.9200 },
      { name: "Шмалена", type: "village", lat: 47.7400, lng: 28.9200 },
    ],
  },
  {
    name: "Дубоссарский",
    settlements: [
      ...
      { name: "Афанасьевка", type: "village", lat: 47.2400, lng: 29.2000 },
      { name: "Боска", type: "village", lat: 47.2750, lng: 29.1900 },
      { name: "Гармацкое", type: "village", lat: 47.2500, lng: 29.2000 },
      { name: "Гояны", type: "village", lat: 47.2300, lng: 29.1800 },
      { name: "Дзержинское", type: "village", lat: 47.2450, lng: 29.1400 },
      { name: "Дойбаны-1", type: "village", lat: 47.2700, lng: 29.1300 },
      { name: "Дойбаны-2", type: "village", lat: 47.2720, lng: 29.1350 },
      { name: "Дубово", type: "village", lat: 47.2450, lng: 29.1900 },
      { name: "Журка", type: "village", lat: 47.2800, lng: 29.1800 },
      { name: "Калиновка", type: "village", lat: 47.2550, lng: 29.1500 },
      { name: "Койково", type: "village", lat: 47.2250, lng: 29.1700 },
      { name: "Красный Виноградарь", type: "village", lat: 47.2400, lng: 29.2100 },
      { name: "Новая Александровка", type: "village", lat: 47.2900, lng: 29.1600 },
      { name: "Новая Кошница", type: "village", lat: 47.2350, lng: 29.1550 },
      { name: "Новая Лунга", type: "village", lat: 47.2650, lng: 29.1800 },
      { name: "Новокомиссаровка", type: "village", lat: 47.2480, lng: 29.1350 },
      { name: "Новые Гояны", type: "village", lat: 47.2250, lng: 29.1900 },
      { name: "Новые Погребы", type: "village", lat: 47.2150, lng: 29.1600 },
      { name: "Роги", type: "village", lat: 47.2900, lng: 29.1500 },
      { name: "Цыбулёвка", type: "village", lat: 47.2550, lng: 29.2000 },
  ...
  },
  {
    ...
    settlements: [
      ...
      { name: "Бруслаки", type: "village", lat: 47.1700, lng: 29.3400 },
      { name: "Бутор", type: "village", lat: 47.1000, lng: 29.3500 },
      { name: "Бычок", type: "village", lat: 47.1200, lng: 29.2700 },
      { name: "Весёлое", type: "village", lat: 47.1350, lng: 29.3600 },
      { name: "Виноградное", type: "village", lat: 47.1150, lng: 29.3100 },
      { name: "Глиное", type: "village", lat: 47.1050, lng: 29.2800 },
      { name: "Гыртоп", type: "village", lat: 47.1400, lng: 29.3100 },
      { name: "Делакеу", type: "village", lat: 47.1450, lng: 29.2800 },
      { name: "Индия", type: "village", lat: 47.1300, lng: 29.2600 },
      { name: "Карманово", type: "village", lat: 47.1350, lng: 29.3300 },
      { name: "Колосово", type: "village", lat: 47.1250, lng: 29.2900 },
      { name: "Котовка", type: "village", lat: 47.1100, lng: 29.2900 },
      { name: "Красная Бессарабия", type: "village", lat: 47.1600, lng: 29.3500 },
      { name: "Красная Горка", type: "village", lat: 47.1450, lng: 29.3400 },
      { name: "Красногорка", type: "village", lat: 47.1650, lng: 29.3200 },
      { name: "Красное", type: "village", lat: 47.1200, lng: 29.3500 },
      { name: "Малаешты", type: "village", lat: 47.1050, lng: 29.2850 },
      { name: "Мариян", type: "village", lat: 47.1550, lng: 29.2700 },
      { name: "Маяк", type: "village", lat: 47.1750, lng: 29.3100 },
      { name: "Мокряки", type: "village", lat: 47.1400, lng: 29.2600 },
      { name: "Мочаровка", type: "village", lat: 47.1300, lng: 29.2400 },
      { name: "Нововладимировка", type: "village", lat: 47.1700, lng: 29.2800 },
      { name: "Победа", type: "village", lat: 47.1150, lng: 29.3000 },
      { name: "Спея", type: "village", lat: 47.0900, lng: 29.2900 },
      { name: "Ташлык", type: "village", lat: 47.1600, lng: 29.2600 },
      { name: "Тея", type: "village", lat: 47.1480, lng: 29.3050 },
      { name: "Токмазея", type: "village", lat: 47.1080, lng: 29.2950 },
      { name: "Федосеевка", type: "village", lat: 47.1250, lng: 29.2700 },
      { name: "Черница", type: "village", lat: 47.1500, lng: 29.2500 },
      { name: "Шипка", type: "village", lat: 47.0950, lng: 29.3100 },
    ],
  },
  {
    name: "Слободзейский",
    settlements: [
      ...
      { name: "Владимировка", type: "village", lat: 46.7200, lng: 29.7400 },
      { name: "Глиное", type: "village", lat: 46.7150, lng: 29.6900 },
      { name: "Карагаш", type: "village", lat: 46.8600, lng: 29.5700 },
      { name: "Кицканы", type: "village", lat: 46.8000, lng: 29.4800 },
      { name: "Константиновка", type: "village", lat: 46.7250, lng: 29.7500 },
      { name: "Коротное", type: "village", lat: 46.7550, lng: 29.7400 },
      { name: "Красное", type: "village", lat: 46.7300, lng: 29.7200 },
      { name: "Меренешты", type: "village", lat: 46.7500, lng: 29.7100 },
      { name: "Незавертайловка", type: "village", lat: 46.7450, lng: 29.6900 },
      { name: "Никольское", type: "village", lat: 46.7100, lng: 29.7300 },
      { name: "Новая Андрияшевка", type: "village", lat: 46.7350, lng: 29.6800 },
      { name: "Новокотовск", type: "village", lat: 46.7200, lng: 29.6600 },
      { name: "Новосавицкая", type: "village", lat: 46.7050, lng: 29.7100 },
      { name: "Парканы", type: "village", lat: 46.8200, lng: 29.5800 },
      { name: "Первомайск", type: "village", lat: 46.7450, lng: 29.7150 },
      { name: "Приозёрное", type: "village", lat: 46.7600, lng: 29.7500 },
      { name: "Старая Андрияшевка", type: "village", lat: 46.7400, lng: 29.6700 },
      { name: "Суклея", type: "village", lat: 46.7900, lng: 29.6500 },
      { name: "Терновка", type: "village", lat: 46.8550, lng: 29.6100 },
      { name: "Уютное", type: "village", lat: 46.7100, lng: 29.6900 },
  ...
  },
  {
    ...
    settlements: [
      ...
      { name: "Днестровск", type: "pgt", lat: 46.8350, lng: 29.5950 },
      { name: "Кременчуг", type: "village", lat: 46.8200, lng: 29.5600 },
      { name: "Новотираспольский", type: "village", lat: 46.8500, lng: 29.6000 },
    ],
  },
  {
    name: "Бендерский",
    settlements: [
      ...
      { name: "Гыска", type: "village", lat: 46.8150, lng: 29.4400 },
