...
export async function POST() {
  try {
    ...
    const playgrounds = [
      ...
      {
        name: 'Площадка в селе Хрустовая',
        description: 'Горная детская площадка с живописным видом. Базовое оборудование для малышей.',
        address: 'ул. Лесная, 7',
        city: 'Хрустовая',
        district: 'Каменский',
        lat: 48.0800,
      ...
      {
        name: 'Колбасна — Спортзона',
        description: 'Спортивная площадка в посёлке Колбасна с турниками и футбольным полем.',
        ...
        status: 'approved',
        photos: JSON.stringify([]),
        equipment: JSON.stringify(['Турники', 'Брусья', 'Мини-футбол', 'Освещение']),
      },
      {
        name: 'Днестровск — Площадка отдыха',
        description: 'Небольшая детская зона в посёлке Днестровск рядом с электростанцией.',
        address: 'ул. Энергетиков, 12',
        city: 'Днестровск',
        district: 'Тираспольский',
        lat: 46.8350,
        lng: 29.5950,
        ...
        status: 'approved',
        photos: JSON.stringify([]),
        equipment: JSON.stringify(['Качели', 'Горки', 'Лавочки']),
      },
      {
        name: 'Гыска — Детский городок',
        description: 'Детская площадка в пригороде Бендер, село Гыска.',
        ...
        status: 'approved',
        photos: JSON.stringify([]),
        equipment: JSON.stringify(['Качели', 'Песочница']),
      },
      {
        name: 'Суклея — Игровой комплекс',
        description: 'Обновлённая площадка в селе Суклея с современным оборудованием.',
        ...
        status: 'approved',
        photos: JSON.stringify([]),
        equipment: JSON.stringify(['Горки', 'Качели', 'Канатная сетка', 'Лавочки', 'Ограждение']),
      },
